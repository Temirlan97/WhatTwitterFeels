...
prefix = "data/Computed/Raw/Results/Tweets/2to500/errors"
...
for x in intervalsAndFrames:
	...
	legend = plt.scatter(csvFile["tweetsN"], csvFile["meanAccuracy"], s=area, c=colors)
	legends.append(legend)
	names.append(name)
	plt.title("Correlation of accuracy to M (interval - frame width)")
	plt.xlabel('M')
	plt.ylabel('Accuracy')
